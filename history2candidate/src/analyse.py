...
def analyse(prediction_path):
    ...
    ax1.set_title('Rank distribution of clicked news (relative)')
    ...
    ax2.set_title('Rank distribution of clicked news (absolute)')

    plt.show()


if __name__ == "__main__":
    analyse('data/test/prediction.txt')